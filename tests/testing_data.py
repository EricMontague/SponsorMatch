...
from app.models import User, Role, Event, EventType, EventCategory, Venue, Package, \
    Image, ImageType, Sponsorship, Permission, SponsorshipStatus, EventStatus
...
class TestModelFactory:
    ...
    @classmethod
    def create_user(cls, password="password", email="greg@gmail.com", company="ABC Corp", has_paid=True, profile_photo_path=None):
    ...
    @classmethod
    def create_event(cls, title, status, event_type="Conference", event_category="Music", id=None):
        ...
        if id is not None: #used for elasticsearch tests where the model isn't added to the db
            event.id = id
        return event
